...
public class TestUtils {
    ...
    public HttpServletRequest setUpHeaderAndGetReq(String email, Long userId) {
        ...
        var refreshDate = StartupConfig.DATE_FORMATTER.format(jwtUtils.getExpirationDate(refresh));
        var accessDate = StartupConfig.DATE_FORMATTER.format(jwtUtils.getExpirationDate(access));
